...
from streamlink.packages.flashmedia.tag import (AACAudioData, AAC_PACKET_TYPE_SEQUENCE_HEADER, AUDIO_CODEC_ID_AAC,
                                                AVCVideoData, AVC_PACKET_TYPE_SEQUENCE_HEADER, AudioData, Header, ScriptData,
                                                TAG_TYPE_AUDIO, TAG_TYPE_VIDEO, Tag, VIDEO_CODEC_ID_AVC, VideoCommandFrame,
                                                VideoData)
